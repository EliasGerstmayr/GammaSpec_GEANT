...
for n = 1:length(variable)
    ...
    for i = 1:length(theta_range)
        ...
        for k = 1:length(phi_range)
            j = j+1;
            phi = phi_range(k);
            macfname = ['/Users/eg415/GEANT/QED/scripts_thetaphi/Gamma_' num2str(var, '%03d') 'MeV_' num2str(theta,'%02d') 'mradTheta_' num2str(phi,'%02d') 'mradPhi.mac'];
            outputfname = ['Gamma_' num2str(var, '%03d') 'MeV_' num2str(theta, '%02d') 'mradTheta_' num2str(phi, '%02d') 'mradPhi'];
...
executecommand_file = 'buffer_thetaphi.txt';
